...
//            }
    ...
    override fun connectToPairedDevice(device: BluetoothDeviceDomain) {
        CoroutineScope(Dispatchers.IO).launch {
    ...
    override suspend fun trySendMessage(gesture: String, xCoordinate: Int, yCoordinate: Int, text: String): BluetoothMessage? {
//        if(!hasPermission(Manifest.permission.BLUETOOTH_CONNECT)) {
//            return null
//        }
